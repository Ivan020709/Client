    ...
    return (
        <div className="diary-section">
            ...
            <div className="diary-tabs">
                ...
                <button
                    type="button"
                    className={diaryTab === "community" ? "active" : ""}
                    onClick={() => setDiaryTab("community")}
                >
                    다른 사람들의 일기
                </button>
            </div>
            ...
            {diaryList.length === 0 ? (
                ...
                <div className="diary-note-list">
                    {diaryList.map((diary, index) => (
                        <DiaryCard
                            key={diary.diaryId || diary.date || index}
                            diary={diary}
                    ...
                    >
                        ...
                        <div className="diary-modal-header">
                            ...
                            <div className="diary-modal-emotion">
                                <span>
                                    {emotionInfo[selectedDiary.emotion]?.emoji || "🙂"}
                                </span>
                                <small>
                                    {emotionInfo[selectedDiary.emotion]?.name || "기록"}
                                </small>
                            </div>
                        </div>
...
function EmotionCalendar({
    ...
    const renderCalendar = () => {
        ...
        for (let day = 1; day <= lastDate; day++) {
            ...
            days.push(
                <div
                    key={day}
                    className={`calendar-day ${emotion || ""} ${isSelected ? "selected" : ""}`}
    ...
    const hasSavedDiary =
        selectedDate && emotionData[selectedDate]?.comment;
            ...
            <div className="emotion-calendar-layout">
                ...
                <div className="emotion-summary">
                    ...
                    <div className="emotion-item">
                        <span>😊 행복</span>
                        <strong>{emotionCount.happy}일</strong>
                    </div>

                    <div className="emotion-item">
                        <span>😌 편안</span>
                        <strong>{emotionCount.calm}일</strong>
                    </div>

                    <div className="emotion-item">
                        <span>😔 우울</span>
                        <strong>{emotionCount.sad}일</strong>
                    </div>

                    <div className="emotion-item">
                        <span>😰 불안</span>
                        <strong>{emotionCount.anxious}일</strong>
                    </div>

                    <div className="emotion-item">
                        <span>😡 화남</span>
                        <strong>{emotionCount.angry}일</strong>
                    </div>
                </div>
            </div>
                ...
                <div className="diary-box">
                        ...
                        <div className="emotion-buttons">
                            {Object.entries(emotionInfo).map(([key, value]) => (
                                <button
                                    key={key}
                                    type="button"
                                    disabled={hasSavedDiary && !isEditing}
                                    className={
                                        selectedEmotion === key
                                            ? "emotion-active"
                                            : ""
                    ...
                    <div className="comment-area">
                        ...
                        <textarea
                            ...
                            maxLength={100}
                            readOnly={hasSavedDiary && !isEditing}
                        />
...
function Diary() {
    ...
    const currentMonthData = Object.entries(
        emotionData
    ).filter(([date]) =>
        date.startsWith(
